...
@section('middle-section')
    <div class="relative overflow-hidden min-h-[80vh]">
        ...
        <div aria-hidden="true" class="flex absolute -top-96 start-1/2 transform -translate-x-1/2">
            ...
            <div
                class="bg-gradient-to-tl from-blue-50/50 via-blue-50/50 to-blue-50/50 blur-3xl w-[90rem] h-[50rem] rounded-fulls origin-top-left -rotate-12 -translate-x-[15rem] dark:from-indigo-900/70 dark:via-indigo-900/70 dark:to-blue-900/70">
            </div>
        </div>
